...
public class WindowsSupport {
    public static String getLastErrorMessage() {
        ...
        Kernel32.FormatMessageW(Kernel32.FORMAT_MESSAGE_FROM_SYSTEM, 0, errorCode, 0, data, bufferSize, null);
    ...
    public static int writeConsole(String msg) {
        ...
        if (Kernel32.WriteConsoleW(hConsole, chars, chars.length, written = new int[1], 0) != 0) {
            return written[0];
        }
        return 0;
    }
